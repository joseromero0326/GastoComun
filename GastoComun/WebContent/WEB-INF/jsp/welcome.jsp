...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="<c:url value='/css/ie/html5shiv.js'/>"></script><![endif]-->
		...
		<noscript>
			...
			<link rel="stylesheet" href="<c:url value='/css/style-wide.css'/>" />
			<link rel="stylesheet" href="<c:url value='/css/style-normal.css'/>" />
		</noscript>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				...
				<!-- Logo -->
					<h1 id="logo">Gasto Com&uacute;n</h1>

				<!-- Nav -->
					<nav id="nav">
						<ul>
							<li><a href="#intro">Hom4</a></li>
